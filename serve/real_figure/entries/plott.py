...
axes[0].set_xticklabels([f"{x:.1f}" for x in xtick_vals],
...
axes[1].set_xticklabels([f"{x:.1f}" for x in xtick_vals],
                        fontsize=tick_fontsize)
...
fig.savefig("compression_eval_examples_final.pdf",
            dpi=300,
            bbox_inches='tight')
plt.close()
