...
parser.add_argument(
    ...
    default="rouge",
    help=
    "Which metric to label on the y-axis: 'rouge' for ROUGE-L, 'f1' for F1 score"
)
...
ttft_base_all, f1_base_all, labels_base_all = load_metrics(file_paths_kivi,
                                                           filter_first=False)
ttft_ours_all, f1_ours_all, labels_ours_all = load_metrics(file_paths_ours,
                                                           filter_first=False)
ttft_pre_all, f1_pre_all, labels_pre_all = load_metrics(file_paths_prefill,
                                                        filter_first=False)
ttft_cat4_all, f1_cat4_all, labels_cat4_all = load_metrics(
    file_paths_streaming, filter_first=False)
ttft_cat5_all, f1_cat5_all, labels_cat5_all = load_metrics(file_paths_offload,
                                                           filter_first=False)
...
ttft_base_nf, f1_base_nf, labels_base_nf = load_metrics(file_paths_kivi,
                                                        filter_first=True)
ttft_ours_nf, f1_ours_nf, labels_ours_nf = load_metrics(file_paths_ours,
                                                        filter_first=True)
ttft_pre_nf, f1_pre_nf, labels_pre_nf = load_metrics(file_paths_prefill,
                                                     filter_first=True)
ttft_cat4_nf, f1_cat4_nf, labels_cat4_nf = load_metrics(file_paths_streaming,
                                                        filter_first=True)
ttft_cat5_nf, f1_cat5_nf, labels_cat5_nf = load_metrics(file_paths_offload,
                                                        filter_first=True)
