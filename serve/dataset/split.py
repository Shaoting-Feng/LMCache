...
df2 = qdf[(qdf['length'] >= 9000) & (qdf['length'] < 10000)]
print(f"QMSUM dataset size with 9000 < length < 10000: {df2.shape}")
df2.to_csv("qmsum_processed_bw_9000_10000.csv", index=False)
